...
public class GamePanel extends JPanel implements ActionListener {
  ...
  public void draw(Graphics g) {
    if (running) {
      ...
      g.drawString("Score: " + applesEaten , (SCREEN_WIDTH - metrics.stringWidth("Score: " + applesEaten) - 10) , 25);
    }
  ...
  public void checkCollisions() {
    ...
    if (x[0] < 0) {
      if (blockBorders) {
        ...
        // Make snake appear at the opposite side
